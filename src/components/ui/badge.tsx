  ...
  "inline-flex items-center border font-medium transition-all duration-200 hover:transform hover:-translate-y-0.5 hover:shadow-sm",
  {
    variants: {
      variant: {
        ...
        barista: "bg-transparent text-amber-600 border-amber-600 rounded px-2.5 py-1 text-xs font-medium hover:shadow-md",
        category: "bg-transparent text-slate-600 border-slate-600 rounded px-2.5 py-1 text-xs font-medium hover:shadow-md",
        flavor: "bg-transparent text-purple-600 border-purple-600 rounded px-2.5 py-1 text-xs font-medium hover:shadow-md",
