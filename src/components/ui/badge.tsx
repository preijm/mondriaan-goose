  ...
  "inline-flex items-center border font-medium",
  {
    variants: {
      variant: {
        ...
        barista: "bg-white/80 backdrop-blur-sm text-amber-600 border border-amber-600 rounded-md px-1.5 h-6 text-xs font-medium hover:shadow-lg",
        category: "bg-white/80 backdrop-blur-sm text-slate-600 border border-slate-600 rounded-md px-1.5 h-6 text-xs font-medium hover:shadow-lg",
        flavor: "bg-white/80 backdrop-blur-sm text-purple-600 border border-purple-600 rounded-md px-1.5 h-6 text-xs font-medium hover:shadow-lg",
