        ...
        <div className="flex items-center justify-center min-h-screen pt-16 pb-20 sm:pb-8">
          <div className="container max-w-4xl mx-auto px-4 py-8 sm:py-12 relative z-10">
            ...
            <div className="relative">
              ...
              {/* Timeline Item 1 */}
              <motion.div className="relative mb-12 sm:mb-16" initial={{
              opacity: 0,
              y: 50
            }} whileInView={{
              opacity: 1,
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 items-start">
                      ...
                      <div className="flex-shrink-0 w-full sm:w-64 space-y-2">
                        <div className="grid grid-cols-2 gap-2 mb-2">
                          <img src={soySauceMilkPhoto} alt="Photo of Alpro plant-based milk carton next to Shoyu soy sauce bottle with a glass showing the terrible mixture" className="rounded-lg w-full border border-border/50 shadow-sm cursor-pointer hover:shadow-lg transition-shadow object-cover aspect-[3/4]" onClick={() => setSelectedImage(soySauceMilkPhoto)} />
                          <img src={milkSoySaucePhoto} alt="Photo of Magere Melk dairy-free milk carton and soy sauce bottle showing the products that inspired the joke" className="rounded-lg w-full border border-border/50 shadow-sm cursor-pointer hover:shadow-lg transition-shadow object-cover aspect-[3/4]" onClick={() => setSelectedImage(milkSoySaucePhoto)} />
                        </div>
                        <p className="text-sm text-muted-foreground text-center italic">
                          The actual culprits: milk meets soy sauce
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-4 sm:gap-8 sm:flex-row-reverse">
                  ...
                  <div className="flex-1 bg-card rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    ...
                    <div className="space-y-2">
                      <img src={spreadsheetImage} alt="Original milk testing spreadsheet with ratings and data" className="rounded-lg w-full border border-border/50 shadow-sm cursor-pointer hover:shadow-lg transition-shadow" onClick={() => setSelectedImage(spreadsheetImage)} />
                      <p className="text-sm text-muted-foreground text-center italic">
                ...
                <div className="flex items-start gap-4 sm:gap-8 sm:flex-row-reverse">
                  ...
                  <div className="flex-1 bg-card rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                    ...
                    delay: 3000
                      ...
                      }].map((image, index) => <CarouselItem key={index} className="pl-2 sm:pl-4 basis-1/2 sm:basis-1/3">
                            <img src={image.src} alt={image.alt} className="rounded-lg w-full h-40 sm:h-48 object-cover border border-border/50 shadow-sm hover:shadow-lg hover:scale-105 transition-all" />
                          </CarouselItem>)}
                      </CarouselContent>
